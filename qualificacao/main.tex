...
\begin{document}
  ...
  \foreigntitle{A Parsing Expression Grammars-based approach for pattern matching in multi-language source code.}
  ...
  % \cleardoublepage
  \include{chapters/trabalhos-futuros}
  % \cleardoublepage
