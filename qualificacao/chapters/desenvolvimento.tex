...
\begin{example}
  ...
  % Esse é um possível padrão:
  %   pattern a : E := (T := (F := ("(" #m:E ")") "*" F := ("3" ε)) ε)
  % Essa é a parse tree que a ferramenta gera:
  %   NT E
  %   ╰╴Seq
  %     ├╴NT T
  %     | ╰╴Seq
...
\begin{figure*}
  \begin{tikzpicture}[
      ...
      % every node/.style={draw, rectangle, align=center, rounded corners, minimum width=3.5cm, minimum height=1.1cm, font=\small},
